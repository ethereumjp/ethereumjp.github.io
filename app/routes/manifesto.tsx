        ...
        <div class="px-4 flex flex-col gap-4">
          ...
          <section>
            ...
            <ol class="list-decimal ml-6 space-y-1">
              <li>
                <strong>Permissionlessness over gatekeeping</strong> — Anyone
                should be able to build, fork, join, contribute, exit, and
                create without asking institutional permission.
              </li>
              <li>
                <strong>Commons over capture</strong> — Ethereum only matters if
